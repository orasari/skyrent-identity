...
export function VerificationFlowPage({
  ...
  const stepIndex = step === 'selfie' ? 1 : step === 'phone' ? 2 : 3;
      ...
      <div className="flex items-center justify-between">
        <div>
          <p className="text-xs font-semibold uppercase tracking-wide text-emerald-600">
            Verification step {stepIndex} of 3
          </p>
      ...
      <div className="grid gap-8">
        {step === 'selfie' && (
          <section className="rounded-xl border border-gray-200 p-5">
            <h3 className="text-lg font-semibold text-gray-900">1. Selfie Capture</h3>
            <p className="text-sm text-gray-600 mb-4">Take a quick selfie to verify identity.</p>
        ...
        {step === 'phone' && (
          <section className="rounded-xl border border-gray-200 p-5">
            <h3 className="text-lg font-semibold text-gray-900">2. Phone Verification</h3>
            <p className="text-sm text-gray-600 mb-4">We’ll normalize your phone number.</p>
            <Suspense fallback={<p className="text-sm text-gray-500">Loading phone input...</p>}>
        ...
        {step === 'address' && (
          <section className="rounded-xl border border-gray-200 p-5">
            ...
            <p className="text-sm text-gray-600 mb-4">Required fields are marked with *.</p>
            <Suspense fallback={<p className="text-sm text-gray-500">Loading address form...</p>}>
